        ...
        <View style={style.container}>
          ...
          <View style={style.sectionCard}>
            <View style={style.contentDirection}>
              <TouchableOpacity>
                <View style={button.payment}>
                  <Image style={button.imageDana} source={Paydana} />
                </View>
              </TouchableOpacity>
              <TouchableOpacity>
                <View style={button.payment}>
                  <Image style={button.imageGopay} source={Paygopay} />
                </View>
              </TouchableOpacity>
              <TouchableOpacity>
                <View style={button.payment}>
                  <Image style={button.imageGpay} source={Paygpay} />
                </View>
              </TouchableOpacity>
            </View>
            ...
            <View style={style.contentDirection}>
              <TouchableOpacity>
                <View style={button.payment}>
                  <Image style={button.imageOvo} source={Payovo} />
                </View>
              </TouchableOpacity>
              <TouchableOpacity>
                <View style={button.payment}>
                  <Image style={button.imagePaypal} source={Paypaypal} />
                </View>
              </TouchableOpacity>
              <TouchableOpacity>
                <View style={button.payment}>
                  <Image style={button.imageVisa} source={Payvisa} />
                </View>
              </TouchableOpacity>
            </View>
            ...
            <View style={style.centerDirection}>
              ...
              <View style={style.spacing}>
                ...
                <TouchableOpacity>
                  <Text style={style.clickableText}> See how it work</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
          ...
          <View style={style.sectionCard}>
            ...
            <View style={style.warning}>
              <Icon name="exclamation-triangle" color="orange" size={25} />
              <Text style={style.warningText}> Fill your data correctly.</Text>
            </View>
          </View>

          <View style={button.confirm}>
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('TicketResults')}>
